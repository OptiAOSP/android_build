...
def LoadInfoDict(input_file, input_dir=None):
  ...
  recovery_fstab_path = "/media/disk/root/CM15.1/out/target/product/codina/root/fstab.samsungcodina"
...
def GetTypeAndDevice(mount_point, info):
  fstab = info["fstab"]
  if not fstab:
    recovery_fstab_path = "/media/disk/root/CM15.1/out/target/product/codina/obj/RECOVERY/RAMDISK/etc/recovery.fstab"
    #fstab_version = 2
    fstab_version = 2
