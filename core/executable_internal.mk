...
ifneq ($(LOCAL_FORCE_STATIC_EXECUTABLE_NOLTO),true)
ifneq ($(filter $(my_static_libraries),libc_nolto),)
$(error $(LOCAL_PATH): $(LOCAL_MODULE) is statically linking libc_nolto to dynamic executable, please remove libc_nolto from static libs or set LOCAL_FORCE_STATIC_EXECUTABLE_NOLTO := true)
endif
endif
...
ifeq ($(LOCAL_FORCE_STATIC_EXECUTABLE_NOLTO),true)
$(linked_module): PRIVATE_POST_LINK_CMD := $(LOCAL_POST_LINK_CMD)
$(linked_module): $(my_target_crtbegin_static_o) $(all_objects) $(all_libraries) $(my_target_crtend_o)
	$(transform-o-to-static-executable-nolto)
	$(PRIVATE_POST_LINK_CMD)
else
